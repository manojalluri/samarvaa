...
export default function About() {
  const schema = JSON.stringify({
    ...
    "@type": "AboutPage",
    "name": "About Samarva Events | Samarva Events",
    "description": "Learn more about Samarva Events, the leading event management company in Andhra Pradesh.",
    "provider": {
      "@type": "Organization",
      "name": "Samarva Events"
    }
  ...
  return (
    <div className="page-container" style={{ paddingTop: '100px', minHeight: '60vh', paddingBottom: '50px', textAlign: 'center' }}>
      <SEO 
        title="About Samarva Events | Samarva Events"
        description="Learn more about Samarva Events, the leading event management company in Andhra Pradesh."
        schema={schema}
      />
      <h1>About Samarva Events</h1>
      <p style={{ marginTop: '20px', fontSize: '1.2rem', maxWidth: '800px', margin: '20px auto' }}>
        Learn more about Samarva Events, the leading event management company in Andhra Pradesh.
      </p>
