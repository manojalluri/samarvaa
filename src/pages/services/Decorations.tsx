...
export default function Decorations() {
  const schema = JSON.stringify({
    ...
    "@type": "Service",
    "name": "Wedding Decoration Services | Samarva Events",
    "description": "Stunning wedding and event decoration services tailored to your theme.",
    "provider": {
      "@type": "Organization",
      "name": "Samarva Events"
    }
  ...
  return (
    <div className="page-container" style={{ paddingTop: '100px', minHeight: '60vh', paddingBottom: '50px', textAlign: 'center' }}>
      <SEO 
        title="Wedding Decoration Services | Samarva Events"
        description="Stunning wedding and event decoration services tailored to your theme."
        schema={schema}
      />
      <h1>Wedding Decoration Services</h1>
      <p style={{ marginTop: '20px', fontSize: '1.2rem', maxWidth: '800px', margin: '20px auto' }}>
        Stunning wedding and event decoration services tailored to your theme.
      </p>
