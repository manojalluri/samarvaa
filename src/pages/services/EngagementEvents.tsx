...
export default function EngagementEvents() {
  const schema = JSON.stringify({
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Engagement Event Planners | Samarva Events",
    "description": "Complete engagement event management and decoration services.",
    "provider": {
      "@type": "Organization",
      "name": "Samarva Events"
    }
  ...
  return (
    <div className="page-container" style={{ paddingTop: '100px', minHeight: '60vh', paddingBottom: '50px', textAlign: 'center' }}>
      <SEO 
        title="Engagement Event Planners | Samarva Events"
        description="Complete engagement event management and decoration services."
        schema={schema}
      />
      <h1>Engagement Event Planners</h1>
      <p style={{ marginTop: '20px', fontSize: '1.2rem', maxWidth: '800px', margin: '20px auto' }}>
        Complete engagement event management and decoration services.
      </p>
