...
export default function WeddingPlannerGuntur() {
  const schema = JSON.stringify({
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Wedding Planner in Guntur | Samarva Events",
    "description": "Expert wedding planners in Guntur offering end-to-end wedding management.",
    "provider": {
      "@type": "Organization",
      "name": "Samarva Events"
    }
  ...
  return (
    <div className="page-container" style={{ paddingTop: '100px', minHeight: '60vh', paddingBottom: '50px', textAlign: 'center' }}>
      <SEO 
        title="Wedding Planner in Guntur | Samarva Events"
        description="Expert wedding planners in Guntur offering end-to-end wedding management."
        schema={schema}
      />
      <h1>Wedding Planner in Guntur</h1>
      <p style={{ marginTop: '20px', fontSize: '1.2rem', maxWidth: '800px', margin: '20px auto' }}>
        Expert wedding planners in Guntur offering end-to-end wedding management.
      </p>
